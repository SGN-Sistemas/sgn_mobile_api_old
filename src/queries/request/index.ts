...
export const selectPedidoEstoque1 = (usuaCod: number, queryString: string) => {
  return `
    SELECT
      PEDI_TOTAL_MERC,
      PEDI_OBS,
...
export const selectPedidoEstoque2 = (usuaCod: number, queryString: string) => {
  return `
    SELECT
      PEDI_OBS,
      PEDI_DESCONTO,
...
export const selectPedidoEstoque3 = (usuaCod: number, queryString: string) => {
  return `
    SELECT
      PEDI_OBS,
      PEDI_DESCONTO,
...
export const selectPedidoEstoque4 = (usuaCod: number, queryString: string) => {
  return `
    SELECT
      PEDI_OBS,
      PEDI_DESCONTO,
...
export const selectPedidoEstoqueCere1 = (usuaCod: number, queryString: string, queryStringPese: string, queryStringPeit: string) => {
  return `
    SELECT
      PEDI_OBS,
      PEDI_DESCONTO,
...
export const selectPedidoEstoqueCere2 = (usuaCod: number, queryString: string, queryStringPese: string, queryStringPeit: string) => {
  return `
    SELECT
      PEDI_OBS,
      PEDI_DESCONTO,
...
export const selectPedidoEstoqueCere3 = (usuaCod: number, queryString: string, queryStringPese: string, queryStringPeit: string) => {
  return `
    SELECT
      PEDI_OBS,
      PEDI_DESCONTO,
...
export const selectPedidoEstoqueCere4 = (usuaCod: number, queryString: string, queryStringPese: string, queryStringPeit: string) => {
  return `
    SELECT
      PEDI_OBS,
      PEDI_DESCONTO,
